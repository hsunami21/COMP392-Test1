...
var game = (function () {
    ...
    function init() {
        ...
        skybox = new gameObject(new THREE.SphereGeometry(45, 32, 32), new THREE.MeshLambertMaterial({ map: THREE.ImageUtils.loadTexture('../../Assets/Images/skybox.jpeg'), side: THREE.BackSide }), 0, 0, 0);
        ...
        cubes.push(new gameObject(new THREE.CubeGeometry(6, 6, 6), new THREE.MeshLambertMaterial({ color: (Math.random() * 0xFFFFFF << 0), map: THREE.ImageUtils.loadTexture('../../Assets/Images/stone.jpg') }), 0, 3, 0));
        cubes.push(new gameObject(new THREE.CubeGeometry(5, 5, 5), new THREE.MeshLambertMaterial({ color: (Math.random() * 0xFFFFFF << 0), map: THREE.ImageUtils.loadTexture('../../Assets/Images/stone.jpg') }), 0, 8.5, 0));
        cubes.push(new gameObject(new THREE.CubeGeometry(4, 4, 4), new THREE.MeshLambertMaterial({ color: (Math.random() * 0xFFFFFF << 0), map: THREE.ImageUtils.loadTexture('../../Assets/Images/stone.jpg') }), 0, 13, 0));
        cubes.push(new gameObject(new THREE.CubeGeometry(3, 3, 3), new THREE.MeshLambertMaterial({ color: (Math.random() * 0xFFFFFF << 0), map: THREE.ImageUtils.loadTexture('../../Assets/Images/stone.jpg') }), 0, 16.5, 0));
        cubes.push(new gameObject(new THREE.CubeGeometry(2, 2, 2), new THREE.MeshLambertMaterial({ color: (Math.random() * 0xFFFFFF << 0), map: THREE.ImageUtils.loadTexture('../../Assets/Images/stone.jpg') }), 0, 19, 0));
